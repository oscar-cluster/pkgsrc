package SystemConfig::Modules::ModulesConf;
...
SystemConfig::Modules::ModulesConf - setup for modules.conf

=head1 SYNOPSIS

 my $modulesconf = new SystemConfig::Modules::ModulesConf(%vars);
...
push @SystemConfig::Hardware::conftypes, qw(SystemConfig::Modules::ModulesConf);
