package SystemConfig::Modules::Generic;
...
SystemConfig::Modules::Generic - Generic modules setup function
...
sub setup {
    ...
    my $mcfile = SystemConfig::Util::FileMod->new(Seperator => ' ', Quotes => '');
