package SystemConfig::Modules::ModutilsAliases;
...
SystemConfig::Modules::ModutilsAliases - setup for /etc/modutils/aliases
...
push @SystemConfig::Hardware::conftypes, qw(SystemConfig::Modules::ModutilsAliases);
