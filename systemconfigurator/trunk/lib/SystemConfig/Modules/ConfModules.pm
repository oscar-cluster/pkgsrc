package SystemConfig::Modules::ConfModules;
...
SystemConfig::Modules::ConfModules - setup for conf.modules

=head1 SYNOPSIS

 my $confmodules = new SystemConfig::Modules::ConfModules(%vars);
...
push @SystemConfig::Hardware::conftypes, qw(SystemConfig::Modules::ConfModules);
