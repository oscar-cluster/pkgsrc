package SystemConfig::Modules::ModprobeConf;
...
SystemConfig::Modules::ModprobeConf - setup for modprobe.conf

=head1 SYNOPSIS

 my $modulesconf = new SystemConfig::Modules::ModprobeConf(%vars);
...
push @SystemConfig::Hardware::conftypes, qw(SystemConfig::Modules::ModprobeConf);
...
L<SystemConfig::Hardware>, L<SystemConfig::Util::FileMod>, L<perl>
