package SystemConfig::Modules::RcConfig;
...
SystemConfig::Modules::RcConfig - setup for /etc/rc.config for kernel modules

=head1 SYNOPSIS

 my $aliases = new SystemConfig::Modules::RcConfig(%vars);
...
push @SystemConfig::Hardware::conftypes, qw(SystemConfig::Modules::RcConfig);
