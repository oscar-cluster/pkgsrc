package SystemConfig::Time::Rdate;
...
use Carp;
use File::Copy;
use SystemConfig::Util::Cmd qw(which);
...
push @SystemConfig::Time::nettime, qw(SystemConfig::Time::NTP);
...
sub setup {
    ...
    my $ntpfile = new SystemConfig::Util::FileMod(Seperator => ' ', Quotes => '', Comment => '#');
