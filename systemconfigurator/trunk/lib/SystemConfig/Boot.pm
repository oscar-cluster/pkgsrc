...
use SystemConfig::Boot::YaBoot;
use SystemConfig::Boot::Iseries;
use SystemConfig::Boot::EFI;
use SystemConfig::Boot::Elilo;
use SystemConfig::Boot::Lilo;
use SystemConfig::Boot::Grub;
use SystemConfig::Boot::Palo;
use SystemConfig::Boot::Aboot;
use SystemConfig::Boot::ZIPL;
use SystemConfig::Boot::Kboot;
...
=head1 NAME
SystemConfig::Boot - The front end to setting up bootloaders in
                     System Configurator. 

=head1 SYNOPSIS
    use SystemConfig::Boot;

    my  @filesmodified = SystemConfig::Boot::setup_boot(%bootvars);
...
L<Config>, L<SystemConfig::Boot::Lilo>,
L<SystemConfig::Boot::Grub>, L<SystemConfig::Boot::YaBoot>
