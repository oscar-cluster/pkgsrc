package SystemConfig::Boot::Elilo;
...
SystemConfig::Boot::Elilo - Elilo bootloader configuration module.

=head1 SYNOPSIS

  my $bootloader = new SystemConfig::Boot::Elilo(%bootvars);
...
push @SystemConfig::Boot::boottypes, qw(SystemConfig::Boot::Elilo);
