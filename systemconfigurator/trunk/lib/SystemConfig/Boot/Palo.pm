package SystemConfig::Boot::Palo;
...
SystemConfig::Boot::Palo - Palo bootloader configuration module.

=head1 SYNOPSIS

  my $bootloader = new SystemConfig::Boot::Palo(%bootvars);
...
push @SystemConfig::Boot::boottypes, qw(SystemConfig::Boot::Palo);
