package SystemConfig::Boot::YaBoot;
...
SystemConfig::Boot::YaBoot - YaBoot bootloader configuration module.

=head1 SYNOPSIS

  my $bootloader = new SystemConfig::Boot::YaBoot(%bootvars);
...
push @SystemConfig::Boot::boottypes, qw(SystemConfig::Boot::YaBoot);
