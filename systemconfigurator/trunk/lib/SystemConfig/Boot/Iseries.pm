package SystemConfig::Boot::Iseries;
...
SystemConfig::Boot::Iseries - Iseries booting configuration module.

=head1 SYNOPSIS

  my $bootloader = new SystemConfig::Boot::Iseries(%bootvars);
...
push @SystemConfig::Boot::boottypes, qw(SystemConfig::Boot::Iseries);
