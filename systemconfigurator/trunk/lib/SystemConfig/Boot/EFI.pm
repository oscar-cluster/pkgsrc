...
SystemConfig::Boot::EFI - EFI bootloader configuration module.

=head1 SYNOPSIS

  my $bootloader = new SystemConfig::Boot::EFI(%bootvars);
...
push @SystemConfig::Boot::boottypes, qw(SystemConfig::Boot::EFI);
