package SystemConfig::Boot::Kboot;
...
SystemConfig::Boot::Kboot - Kboot bootloader configuration module.

=head1 SYNOPSIS

  my $bootloader = new SystemConfig::Boot::Kboot(%bootvars);
...
push @SystemConfig::Boot::boottypes, qw(SystemConfig::Boot::Kboot);
