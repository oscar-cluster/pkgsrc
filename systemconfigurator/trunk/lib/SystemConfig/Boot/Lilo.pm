package SystemConfig::Boot::Lilo;
...
SystemConfig::Boot::Lilo - Lilo bootloader configuration module.

=head1 SYNOPSIS

  my $bootloader = new SystemConfig::Boot::Lilo(%bootvars);
...
push @SystemConfig::Boot::boottypes, qw(SystemConfig::Boot::Lilo);
