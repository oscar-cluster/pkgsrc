package SystemConfig::Boot::ZIPL;
...
SystemConfig::Boot::ZIPL - ZIPL bootloader configuration module.

=head1 SYNOPSIS

  my $bootloader = new SystemConfig::Boot::ZIPL(%bootvars);
...
push @SystemConfig::Boot::boottypes, qw(SystemConfig::Boot::ZIPL);
