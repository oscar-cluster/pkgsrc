package SystemConfig::Network::RawNetwork;
...
SystemConfig::Network::RawNetwork - Raw /etc/init.d/network Module

=head1 SYNOPSIS

  my $networking = new SystemConfig::Network::RawNetwork(%vars);
...
push @SystemConfig::Network::nettypes, qw(SystemConfig::Network::RawNetwork);
