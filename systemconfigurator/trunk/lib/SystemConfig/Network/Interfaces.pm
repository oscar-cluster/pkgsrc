package SystemConfig::Network::Interfaces;
...
SystemConfig::Network::Interfaces - Interfaces Networking Module

=head1 SYNOPSIS

  my $networking = new SystemConfig::Network::Interfaces(%vars);
...
push @SystemConfig::Network::nettypes, qw(SystemConfig::Network::Interfaces);
...
L<SystemConfig::Network>, L<SystemConfig::Network::Generic>, L<perl>
