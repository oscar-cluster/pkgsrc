package SystemConfig::Network::SuSE8;
...
SystemConfig::Network::SuSE8 - SuSE8 Networking Module

=head1 SYNOPSIS

  my $networking = new SystemConfig::Network::SuSE8(%vars);
...
push @SystemConfig::Network::nettypes, qw(SystemConfig::Network::SuSE8);
