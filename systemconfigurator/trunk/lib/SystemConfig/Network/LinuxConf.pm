package SystemConfig::Network::LinuxConf;
...
SystemConfig::Network::LinuxConf - Linux Conf Networking Module

=head1 SYNOPSIS

  my $networking = new SystemConfig::Network::LinuxConf(%vars);
...
push @SystemConfig::Network::nettypes, qw(SystemConfig::Network::LinuxConf);
...
sub setup_global {
    ...
    my $rcfile = new SystemConfig::Util::FileMod(
                                                 Seperator => '=', 
                                                 Quotes => ''
                                                );
    my $somethingtodo = 0;
