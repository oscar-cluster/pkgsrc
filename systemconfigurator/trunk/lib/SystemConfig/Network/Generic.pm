package SystemConfig::Network::Generic;
...
SystemConfig::Network::Generic - A generic networking module

=head1 SYNOPSIS

  package SystemConfig::Network::TypeA;

  use base qw(SystemConfig::Network::Generic);

  my $networking = new SystemConfig::Network::TypeA(%vars);
...
use strict;
use Carp;
use SystemConfig::Network::Interface;
use Data::Dumper;
...
sub new {
    ...
    foreach my $int (sort keys %$intcfg) {
        my $interface = SystemConfig::Network::Interface->new(%{$intcfg->{$int}});
...
L<SystemConifg::Network>, L<SystemConfig::Net::Netmask>, L<perl>
