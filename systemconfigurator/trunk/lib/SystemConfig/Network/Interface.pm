package SystemConfig::Network::Interface;
...
SystemConfig::Network::Interface - a network interface abstraction

=head1 SYNOPSIS

  my $interface = new SystemConfig::Network::Interface(
                                         DEVICE => 'eth0',
...
sub new {
    ...
    if ($this{_TYPE} eq "static" and $this{_IPADDR} and $this{_NETMASK}) {
        my $network = SystemConfig::Net::Netmask->new($this{_IPADDR},$this{_NETMASK});
...
Most of the hard work of this module is done by the L<SystemConfig::Net::Netmask> module
written by David Muir Sharnoff.  The rest is just a mild abstraction layer on top
of that.

L<SystemConfig::Network>, L<SystemConfig::Net::Netmask>, L<perl>
