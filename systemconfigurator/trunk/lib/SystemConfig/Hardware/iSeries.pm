package SystemConfig::Hardware::iSeries;
...
push @SystemConfig::Hardware::hardtypes, qw(SystemConfig::Hardware::iSeries);
...
SystemConfig::Hardware::iSeries - detect pci devices from /proc/bus/pci/devices

=head1 SYNOPSIS

  my $detector = new SystemConfig::Hardware::iSeries([root => $altroot]);
