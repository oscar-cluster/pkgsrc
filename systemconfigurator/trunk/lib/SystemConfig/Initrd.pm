...
use SystemConfig::Initrd::SuSE;
use SystemConfig::Initrd::RH;
use SystemConfig::Initrd::Debian;

$VERSION = sprintf("%d", q$Revision: 664 $ =~ /(\d+)/);

=head1 NAME

SystemConfig::Initrd - builds initial ramdisks for kernels
