...
use strict;
use Carp;
use SystemConfig::Network::LinuxConf;
use SystemConfig::Network::Interfaces;
use SystemConfig::Network::RCConfig;
use SystemConfig::Network::RawNetwork;
use SystemConfig::Network::SuSE8;
use Data::Dumper;
...
my @filesmodified = SystemConfig::Network::setup(%vars);
...
L<SystemConfig::Network::Generic>
