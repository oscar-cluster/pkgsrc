package Modules::SuSE8;

#   $Id: SuSE8.pm,v 1.3 2003/06/27 21:08:03 sdague Exp $
...
Modules::SuSE8 - setup for /etc/rc.config for kernel modules

=head1 SYNOPSIS

 my $aliases = new Modules::SuSE8(%vars);
...
push @Hardware::conftypes, qw(Modules::SuSE8);
