#########################################################################
#  File  : SelectorTableItem.pm                                         #
#  Author: Terrence G. Fleury (tfleury@ncsa.uiuc.edu)                   #
#  Date  : October 29, 2003                                             #
#  This perl package is a subclass of a Qt QTableItem.  I had to        #
#  subclass  QTableItem since I need control over the color of the      #
...
#              (2) EditType of the table                                #
#              (3) Text of the item in the table                        #
#  Returns   : Reference to a new SelectorTableItem object.             #
#########################################################################
...
#  Returns   : Nothing                                                  #
#  This subroutine gets called when a textbox in the table needs to be  #
