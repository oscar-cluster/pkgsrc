...
/**
  * @file xen-hvm.h
  * @brief Declares all classes for the management of Xen virtual machines,
  *        based on full-virtualization.
  * @author Geoffroy Vallee.
  *
  * This class defines all the caracteristics of a xen virtual machine using
  * hardware virtualization support (HVM, i.e., Intel-VT or AMD-V).
  * Should be created every time we want to manipulate a xen virtual machine.
  */
