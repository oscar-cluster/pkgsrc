...
/**
  * @file ProfileXMLNode.h
  * @brief This defines a class for XML profile parsing.
  * @author Geoffroy Vallee.
  *
  * This defines a class for XML profile parsing. It also defines a class for
  * virtual file systems (experimental).
  */
